...
public interface DocumentMap extends Map<String, Object> {
    ...
    DocumentMap getSectionNullable(String s);
    ...
    default List<Long> getLongListNullable(String s) {
        return containsKey(s) ? getLongList(s) : null;
    }
    ...
    DocumentMap createSection(String s);

    DocumentMap createSection(String s, Map<String, Object> map);

    JsonFileMap toFJsonSection();
