...
public class GhastDeliveryMoveFromLoadTask extends MobDeliveryMovementTask {
    ...
    public GhastDeliveryMoveFromLoadTask(DeliveryDocument model) {
        super(GhastDeliveryTaskType.MOVE_FROM_LOAD, model, model.getCurrentLocation(), Locations.atCloudLevel(model.getUnloadLocation()));
    }
