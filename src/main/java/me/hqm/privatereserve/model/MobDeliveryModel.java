...
public class MobDeliveryModel implements Model {
    // -- DATA -- //
    ...
    public MobDeliveryModel(Entity entity, String name, String ownerId) {
    ...
    public MobDeliveryModel(String id, DataSection data) {
        this.id = id;
    ...
    public Location getHomeLocation() {
        return LocationUtil.locationFromString(homeLocation);
    }

    public Location getLoadLocation() {
        return LocationUtil.locationFromString(loadLocation);
    }

    public Location getUnloadLocation() {
        return LocationUtil.locationFromString(unloadLocation);
    }
    ...
    public void setHomeLocation(Location homeLocation) {
        this.homeLocation = LocationUtil.stringFromLocation(homeLocation);
        register();
    }

    public void setLoadLocation(Location loadLocation) {
        this.loadLocation = LocationUtil.stringFromLocation(loadLocation);
        register();
    }

    public void setUnloadLocation(Location unloadLocation) {
        this.unloadLocation = LocationUtil.stringFromLocation(unloadLocation);
        register();
    }
    ...
    public void register() {
        PrivateReserve.MOB_DELIVERY_R.register(this);
    }
}
