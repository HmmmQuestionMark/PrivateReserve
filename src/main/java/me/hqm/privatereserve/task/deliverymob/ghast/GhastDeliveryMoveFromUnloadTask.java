...
public class GhastDeliveryMoveFromUnloadTask extends MobDeliveryMovementTask {
    ...
    public GhastDeliveryMoveFromUnloadTask(MobDeliveryModel model) {
        super(GhastDeliveryTaskType.MOVE_FROM_UNLOAD, model, model.getCurrentLocation(), LocationUtil.atCloudLevel(model.getLoadLocation()));
    }
